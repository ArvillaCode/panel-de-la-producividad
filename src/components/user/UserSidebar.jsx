...
const UserSidebar = ({
  ...
  const sidebarClasses = isMobile
    ...
    : `glass-card w-full !rounded-none border-y-0 border-l-0 shadow-2xl flex flex-col h-full sticky top-0 border-r border-white/10 transition-all duration-300 overflow-hidden`;
  ...
  return (
    <div className={sidebarClasses}>
      ...
      <div className={`mt-auto p-4 pb-16 border-t border-slate-100 dark:border-white/10 ${isMobile ? 'bg-slate-50/50 dark:bg-deep-dark/50' : 'bg-transparent'}`}>
