...
const AgentCompactCard = ({ agent, isFavorite, onToggleFavorite, animationDelay = 0 }) => {
  ...
  return (
    <div 
      className="agent-card group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-gray-700/50 p-4 flex items-center gap-4 animate-in fade-in slide-in-from-bottom-2"
